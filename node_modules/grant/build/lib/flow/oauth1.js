...
exports.authorize = function (provider, req) {
  return new Promise(function (resolve) {
    if (!req.oauth_token && !req.code) {
      var err = new Error();
      err.body = Object.keys(req).length ? req : { error: 'Grant: OAuth1 missing oauth_token parameter' };
      throw err;
    }
...
exports.access = function (provider, req, authorize) {
  return new Promise(function (resolve, reject) {
    if (!authorize.oauth_token && !req.code) {
      var err = new Error();
      err.body = Object.keys(authorize).length ? authorize : { error: 'Grant: OAuth1 missing oauth_token parameter' };
      throw err;
    }
    var options = {
      method: 'POST',
